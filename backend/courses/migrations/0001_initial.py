    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_path', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.careerpath')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='courses_user_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='courses_user_permissions_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
